...
public final class CraftBrewingStand extends org.bukkit.craftbukkit.v1_16_R3.block.data.CraftBlockData implements org.bukkit.block.data.type.BrewingStand {
    ...
    // org.bukkit.craftbukkit.v1_16_R2.block.data.type.CraftBrewingStand

    private static final net.minecraft.state.BooleanProperty[] HAS_BOTTLE = new net.minecraft.state.BooleanProperty[]{
