...
public final class CraftSkull extends org.bukkit.craftbukkit.v1_16_R3.block.data.CraftBlockData implements org.bukkit.block.data.Rotatable {
    ...
    private static final net.minecraft.state.IntegerProperty ROTATION = getInteger(net.minecraft.block.SkullBlock.class, "rotation");
