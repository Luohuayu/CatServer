...
public final class CraftFloorSign extends org.bukkit.craftbukkit.v1_16_R3.block.data.CraftBlockData implements org.bukkit.block.data.type.Sign, org.bukkit.block.data.Rotatable, org.bukkit.block.data.Waterlogged {
    ...
    // org.bukkit.craftbukkit.v1_16_R2.block.data.CraftRotatable

    private static final net.minecraft.state.IntegerProperty ROTATION = getInteger(net.minecraft.block.StandingSignBlock.class, "rotation");
    ...
    private static final net.minecraft.state.BooleanProperty WATERLOGGED = getBoolean(net.minecraft.block.StandingSignBlock.class, "waterlogged");
