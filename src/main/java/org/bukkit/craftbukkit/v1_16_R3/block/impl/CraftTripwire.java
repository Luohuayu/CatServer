...
public final class CraftTripwire extends org.bukkit.craftbukkit.v1_16_R3.block.data.CraftBlockData implements org.bukkit.block.data.type.Tripwire, org.bukkit.block.data.Attachable, org.bukkit.block.data.MultipleFacing, org.bukkit.block.data.Powerable {
    ...
    // org.bukkit.craftbukkit.v1_16_R2.block.data.type.CraftTripwire

    private static final net.minecraft.state.BooleanProperty DISARMED = getBoolean(net.minecraft.block.TripWireBlock.class, "disarmed");
    ...
    private static final net.minecraft.state.BooleanProperty ATTACHED = getBoolean(net.minecraft.block.TripWireBlock.class, "attached");
    ...
    private static final net.minecraft.state.BooleanProperty POWERED = getBoolean(net.minecraft.block.TripWireBlock.class, "powered");
