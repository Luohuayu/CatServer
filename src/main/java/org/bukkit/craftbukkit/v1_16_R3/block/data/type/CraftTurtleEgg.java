...
public abstract class CraftTurtleEgg extends CraftBlockData implements TurtleEgg {
    ...
    private static final net.minecraft.state.IntegerProperty EGGS = getInteger("eggs");
    private static final net.minecraft.state.IntegerProperty HATCH = getInteger("hatch");
