...
public final class CraftWitherSkull extends org.bukkit.craftbukkit.v1_16_R3.block.data.CraftBlockData implements org.bukkit.block.data.Rotatable {

    public CraftWitherSkull() {
        super();
    }

    public CraftWitherSkull(net.minecraft.block.BlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.v1_16_R2.block.data.CraftRotatable

    private static final net.minecraft.state.IntegerProperty ROTATION = getInteger(net.minecraft.block.WitherSkeletonSkullBlock.class, "rotation");
