...
import org.bukkit.craftbukkit.v1_16_R3.inventory.CraftMetaItem.ItemMetaKey.Specific.To;
...
class CraftMetaFirework extends CraftMetaItem implements FireworkMeta {
    ...
    CraftMetaFirework(CompoundNBT tag) {
        ...
        ListNBT fireworkEffects = fireworks.getList(EXPLOSIONS.NBT, CraftMagicNumbers.NBT.TAG_COMPOUND);
