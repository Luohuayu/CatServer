...
public class CraftShapedRecipe extends ShapedRecipe implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        MinecraftServer.getServer().getRecipeManager().addRecipe(new net.minecraft.item.crafting.ShapedRecipe(CraftNamespacedKey.toMinecraft(this.getKey()), this.getGroup(), width, shape.length, data, CraftItemStack.asNMSCopy(this.getResult())));
    }
}
