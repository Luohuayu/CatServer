...
public class CraftMetaBook extends CraftMetaItem implements BookMeta {
                ...
                if (meta instanceof CraftMetaBookSigned) {
                    ...
                    if (this instanceof CraftMetaBookSigned) {
                        ...
                        for (String page : bookMeta.pages) {
                            ...
                            ITextComponent component = CraftChatMessage.fromString(page, true, true)[0];
    ...
    private class SpigotMeta extends BookMeta.Spigot {
        ...
        public BaseComponent[] getPage(final int page) {
            Validate.isTrue(isValidPage(page), "Invalid page number");
            if (CraftMetaBook.this.pages == null) return new BaseComponent[0]; // LoliServer - Fix NPE
        ...
        public void setPage(final int page, final BaseComponent... text) {
            ...
            if (CraftMetaBook.this.pages == null) CraftMetaBook.this.pages = new ArrayList<String>(); // LoliServer - Fix NPE
