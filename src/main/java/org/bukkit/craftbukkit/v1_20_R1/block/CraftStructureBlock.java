...
public class CraftStructureBlock extends CraftBlockEntityState<StructureBlockEntity> implements Structure {
    ...
    public BlockVector getRelativePosition() {
        return CraftBlockVector.toBukkit(getSnapshot().getStructurePos()); // CatServer - structurePos -> getStructurePos()
    }
    ...
    public void setRelativePosition(BlockVector vector) {
        ...
        getSnapshot().setStructurePos(CraftBlockVector.toBlockPosition(vector)); // CatServer - structurePos -> setStructurePos()
    }

    @Override
    public BlockVector getStructureSize() {
        return CraftBlockVector.toBukkit(getSnapshot().getStructureSize()); // CatServer - structureSize -> getStructureSize()
    }
    ...
    public void setStructureSize(BlockVector vector) {
        ...
        getSnapshot().setStructureSize(CraftBlockVector.toBlockPosition(vector)); // CatServer - structureSize -> setStructureSize()
    }

    @Override
    public void setMirror(Mirror mirror) {
        Preconditions.checkArgument(mirror != null, "Mirror cannot be null");
        getSnapshot().setMirror(net.minecraft.world.level.block.Mirror.valueOf(mirror.name())); // CatServer - mirror -> setMirror()
    }

    @Override
    public Mirror getMirror() {
        return Mirror.valueOf(getSnapshot().getMirror().name()); // CatServer - mirror -> getMirror()
    }

    @Override
    public void setRotation(StructureRotation rotation) {
        Preconditions.checkArgument(rotation != null, "StructureRotation cannot be null");
        getSnapshot().setRotation(Rotation.valueOf(rotation.name())); // CatServer - rotation -> setRotation()
    }

    @Override
    public StructureRotation getRotation() {
        return StructureRotation.valueOf(getSnapshot().getRotation().name()); // CatServer - rotation -> getRotation()
    }

    @Override
    public void setUsageMode(UsageMode mode) {
        Preconditions.checkArgument(mode != null, "UsageMode cannot be null");
        getSnapshot().setMode(StructureMode.valueOf(mode.name())); // CatServer - mode -> setMode()
    }
    ...
    public void setIgnoreEntities(boolean flag) {
        getSnapshot().setIgnoreEntities(flag); // CatServer - ignoreEntities -> setIgnoreEntities()
    }

    @Override
    public boolean isIgnoreEntities() {
        return getSnapshot().isIgnoreEntities(); // CatServer - ignoreEntities -> isIgnoreEntities()
    }
    ...
    public void setIntegrity(float integrity) {
        ...
        getSnapshot().setIntegrity(integrity); // CatServer - integrity -> setIntegrity()
    }

    @Override
    public float getIntegrity() {
        return getSnapshot().getIntegrity(); // CatServer - integrity -> getIntegrity()
    }

    @Override
    public void setSeed(long seed) {
        getSnapshot().setSeed(seed); // CatServer - seed -> setSeed()
    }

    @Override
    public long getSeed() {
        return getSnapshot().getSeed(); // CatServer - seed -> getSeed()
    }
    ...
    public void setMetadata(String metadata) {
        ...
        if (getUsageMode() == UsageMode.DATA) {
            getSnapshot().setMetaData(metadata); // CatServer - metaData -> setMetaData()
        }
    }

    @Override
    public String getMetadata() {
        return getSnapshot().getMetaData(); // CatServer - metaData -> getMetaData()
    }
