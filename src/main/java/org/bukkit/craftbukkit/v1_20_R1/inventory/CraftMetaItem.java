...
import org.bukkit.craftbukkit.v1_20_R1.inventory.CraftMetaItem.ItemMetaKey.Specific;
...
class CraftMetaItem implements ItemMeta, Damageable, Repairable, BlockDataMeta {
    ...
    public static Set<String> getCustomTags() {
        synchronized (CUSTOM_TAGS) {
            if (CUSTOM_TAGS.isEmpty()) {
                CUSTOM_TAGS.addAll(Arrays.asList(
                        CraftMetaArmor.TRIM.NBT, // 1.20.1
                        CraftMetaArmor.TRIM_MATERIAL.NBT, // 1.20.1
                        CraftMetaArmor.TRIM_PATTERN.NBT, // 1.20.1
                        CraftMetaMap.MAP_SCALING.NBT,
                        CraftMetaMap.MAP_COLOR.NBT, // 1.18.2
                        ...
                        CraftMetaAxolotlBucket.VARIANT.NBT, // 1.18.2
                        ...
                        CraftMetaBundle.ITEMS.NBT, // 1.18.2
                        CraftMetaMusicInstrument.GOAT_HORN_INSTRUMENT.NBT // 1.20.1
                ));
            }
            return CUSTOM_TAGS;
        }
    ...
    ListTag createStringList(List<String> list) {
        ...
        for (String value : list) {
            ...
            tagList.add(StringTag.valueOf(version <= 0 || version >= 1803 ? value : CraftChatMessage.fromJSONComponent(value))); // SPIGOT-4935
        }
