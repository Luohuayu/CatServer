...
public class CraftMerchantRecipe extends MerchantRecipe {
    ...
    public CraftMerchantRecipe(net.minecraft.world.item.trading.MerchantOffer merchantRecipe) {
        super(CraftItemStack.asBukkitCopy(merchantRecipe.getResult()), 0); // CatServer
        this.handle = merchantRecipe;
        addIngredient(CraftItemStack.asBukkitCopy(merchantRecipe.getBaseCostA())); // CatServer
        addIngredient(CraftItemStack.asBukkitCopy(merchantRecipe.getCostB())); // CatServer
    }
    ...
    public void setSpecialPrice(int specialPrice) {
        handle.setSpecialPriceDiff(specialPrice); // CatServer
    }

    @Override
    public int getDemand() {
        return handle.getDemand(); // CatServer
    }
    ...
    @Override
    public int getUses() {
        return handle.getUses(); // CatServer
    }
    ...
    public int getMaxUses() {
        return handle.getMaxUses(); // CatServer
    }
    ...
    public float getPriceMultiplier() {
        return handle.getPriceMultiplier(); // CatServer
    }
