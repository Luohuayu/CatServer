...
public final class CraftItemStack extends ItemStack {
    ...
    public static ItemStack asBukkitCopy(net.minecraft.world.item.ItemStack original) {
        ...
        catserver.server.inventory.CatForgeItemCap.setItemCap(original, stack); // CatServer
        return stack;
    }
    ...
    private CraftItemStack(net.minecraft.world.item.ItemStack item) {
        this.handle = item;
        catserver.server.inventory.CatForgeItemCap.setItemCap(item, this); // CatServer
    }
