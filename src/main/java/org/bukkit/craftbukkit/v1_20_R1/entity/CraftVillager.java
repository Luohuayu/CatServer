...
public class CraftVillager extends CraftAbstractVillager implements Villager {
    ...
    public static Profession nmsToBukkitProfession(VillagerProfession nms) {
        return ForgeRegistries.VILLAGER_PROFESSIONS.getKey(nms).getNamespace().equals(org.bukkit.NamespacedKey.MINECRAFT) ? Profession.valueOf(BuiltInRegistries.VILLAGER_PROFESSION.getKey(nms).getPath().toUpperCase(Locale.ROOT)) : Profession.valueOf(catserver.server.BukkitInjector.standardize(ForgeRegistries.VILLAGER_PROFESSIONS.getKey(nms))); // CatServer
    }

    public static VillagerProfession bukkitToNmsProfession(Profession bukkit) {
        return !catserver.server.BukkitInjector.professionMap.containsKey(bukkit) ? BuiltInRegistries.VILLAGER_PROFESSION.get(CraftNamespacedKey.toMinecraft(bukkit.getKey())) : ForgeRegistries.VILLAGER_PROFESSIONS.getValue(catserver.server.BukkitInjector.professionMap.get(bukkit)); // CatServer
    }
}
