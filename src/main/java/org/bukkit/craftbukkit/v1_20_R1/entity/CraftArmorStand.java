...
public class CraftArmorStand extends CraftLivingEntity implements ArmorStand {
    ...
    public EulerAngle getBodyPose() {
        return fromNMS(getHandle().getBodyPose()); // CatServer - bodyPose -> getBodyPose()
    }
    ...
    public EulerAngle getLeftArmPose() {
        return fromNMS(getHandle().getLeftArmPose()); // CatServer - leftArmPose -> getLeftArmPose()
    }
    ...
    public EulerAngle getRightArmPose() {
        return fromNMS(getHandle().getRightArmPose()); // CatServer - rightArmPose -> getRightArmPose()
    }
    ...
    public EulerAngle getLeftLegPose() {
        return fromNMS(getHandle().getLeftLegPose()); // CatServer - leftLegPose -> getLeftLegPose()
    }
    ...
    public EulerAngle getRightLegPose() {
        return fromNMS(getHandle().getRightLegPose()); // CatServer - rightLegPose -> getRightLegPose()
    }
    ...
    public EulerAngle getHeadPose() {
        return fromNMS(getHandle().getHeadPose()); // CatServer - headPose -> getHeadPose()
    }
