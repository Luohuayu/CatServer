...
import org.bukkit.craftbukkit.v1_18_R2.Overridden;
...
import org.bukkit.craftbukkit.v1_18_R2.inventory.tags.DeprecatedCustomTagContainer;
    ...
    static void safelyAdd(Iterable<?> addFrom, Collection<String> addTo, boolean possiblyJsonInput) {
        ...
        for (Object object : addFrom) {
            if (!(object instanceof String)) {
                ...
                addTo.add(CraftChatMessage.toJSON(new TextComponent("")));
            } else {
