...
public class ActivationRange
{
    ...
    public static void activateEntities(World world)
    {
        ...
        for ( EntityPlayer player : world.playerEntities )
        {
            ...
            maxBB = player.getEntityBoundingBox().addCoord( maxRange, 256, maxRange );
            miscBB = player.getEntityBoundingBox().addCoord( miscActivationRange, 256, miscActivationRange );
            animalBB = player.getEntityBoundingBox().addCoord( animalActivationRange, 256, animalActivationRange );
            monsterBB = player.getEntityBoundingBox().addCoord( monsterActivationRange, 256, monsterActivationRange );
    ...
    public static boolean checkEntityImmunities(Entity entity)
    {
        ...
        if ( entity instanceof EntityLiving )
        {
            ...
            //Svarka
            if ( living.getLastAttackerTime() > 0 ||  living.hurtTime > 0 || living.activePotionsMap.size() > 0 )
            {
                return true;
            }
    ...
    public static boolean checkIfActive(Entity entity)
    {
        ...
        Chunk chunk = entity.worldObj.getChunkIfLoaded( x >> 4, z >> 4 );
