    ...
    public void run() {
        while (!stopping) {
            ...
            if (lastTick != 0 && timeoutTime > 0 && monotonicMillis() > lastTick + timeoutTime) {
                ...
                log.log(Level.SEVERE, "The server has stopped responding! This is (probably) not a CatServer bug.");
                ...
                log.log(Level.SEVERE, "CatServer Version: " + CatServer.getBuildVersion()); // FoxServer
                //
