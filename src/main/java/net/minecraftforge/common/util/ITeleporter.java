...
public interface ITeleporter
{
    ...
    {
        return this.isVanilla() ? defaultPortalInfo.apply(destWorld) : new PortalInfo(entity.position(), Vector3d.ZERO, entity.yRot, entity.xRot).putCB(destWorld, null);  // CatServer
    }
