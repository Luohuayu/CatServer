...
public class LazyOptional<T>
{
    ...
    private T getValueUnsafe()
    {
        ...
        if (ret == null)
        {
            LOGGER.error("LazyOptional is empty or otherwise returned null from getValue() unexpectedly", new IllegalStateException()); // throw new IllegalStateException("LazyOptional is empty or otherwise returned null from getValue() unexpectedly"); // CatServer - Don't throw exception
        }
        return ret;
    }
