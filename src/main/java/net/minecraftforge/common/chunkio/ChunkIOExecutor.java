...
public class ChunkIOExecutor
{
    ...
    {
        if (catserver.server.CatServer.asyncCatch("load chunk")) return catserver.server.CatServer.postPrimaryThread(() -> syncChunkLoad(world, loader, provider, x, z)); // CatServer
