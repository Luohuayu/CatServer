...
public final class FluidInteractionRegistry
{
    ...
    public record InteractionInformation(HasFluidInteraction predicate, FluidInteraction interaction)
    {
        ...
        public InteractionInformation(HasFluidInteraction predicate, Function<FluidState, BlockState> getState)
        {
            ...
            {
                // CatServer start - 1.20.1 from LiquidBlock#shouldSpreadLiquid
                if (org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.handleBlockFormEvent(level, currentPos, ForgeEventFactory.fireFluidPlaceBlockEvent(level, currentPos, currentPos, getState.apply(currentState)))) {
                    level.levelEvent(1501, currentPos, 0); // LiquidBlock#fizz
                }
                // CatServer end
            });
        }
