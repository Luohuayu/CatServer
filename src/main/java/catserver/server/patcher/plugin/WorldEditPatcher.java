...
public class WorldEditPatcher implements IPatcher {
    ...
    public byte[] transform(String className, byte[] basicClass) {
        if (className.equals("com.sk89q.worldedit.bukkit.WorldEditPlugin")) {
            System.setProperty("worldedit.bukkit.adapter", "com.sk89q.worldedit.bukkit.adapter.impl.Spigot_v1_16_R3");
        ...
        } else if (className.equals("com.sk89q.worldedit.bukkit.adapter.impl.Spigot_v1_16_R3")) {
            return patchSpigot_v1_16_R3(basicClass);
        }
        return basicClass;
    }
    ...
    private byte[] patchSpigot_v1_16_R3(byte[] basicClass) {
        ClassReader reader = new ClassReader(basicClass);
        ClassNode node = new ClassNode();
        reader.accept(node, 0);
